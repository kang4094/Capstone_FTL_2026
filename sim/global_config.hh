...
typedef enum {
  ...
  GLOBAL_WL_SUMMARY_FILE,
  GLOBAL_WL_SNAPSHOT_FILE,
  GLOBAL_WL_SNAPSHOT_INIT_FILE,
  GLOBAL_FIRST_DEATH_FILE,
...
class Config : public SimpleSSD::BaseConfig {
 private:
  ...
  std::string wlSummaryFile;
  std::string wlSnapshotFile;
  std::string wlSnapshotInitFile;
  std::string firstDeathFile;
