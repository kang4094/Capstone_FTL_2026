...
#ifndef __FTL_LA_PAGE_MAPPING__
#define __FTL_LA_PAGE_MAPPING__
...
class LAPageMapping : public AbstractFTL {
 private:
  PAL::PAL *pPAL;
 ...
 public:
  LAPageMapping(ConfigReader &, Parameter &, PAL::PAL *, DRAM::AbstractDRAM *);
  ~LAPageMapping();
